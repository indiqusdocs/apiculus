...
To view networking, navigate to **Kubernetes** and select a **cluster details**. This section manage a cluster's firewalls and ingress networking. Port forwarding and load balancing rules can also be managed using kubectl.
