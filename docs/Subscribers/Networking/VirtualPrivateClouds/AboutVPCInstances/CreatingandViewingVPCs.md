...
9. Clicking the **BUY HOURLY** or **BUY MONTHLY** button, a confirmation appears, and the price summary is displayed along with the discount codes, if you have any in your account. 
    1. You can apply any of the discount codes listed by clicking on the **APPLY** button. 
    2. You can also remove the applied discount code by clicking the **REMOVE** button.       ![Creating VPC](img/CreateVPC4.png)
