...
To add a tier to your VPC, follow these steps:
1. Navigate to the VPC, select the **Subnets and Tiers** section. The following screen appears:
...
2. Click **I confirm that I have removed everything from this tier** checkbox.
3. Click **Delete Tier** button.
