...
- Subscriptions can be canceled (or deactivated) at any time. However, while canceling, you can delete the subscription immediately (instant deletion) or just cancel the automatic renewal (scheduled deletion).
